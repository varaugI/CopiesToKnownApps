...
export const ChannelsTab: React.FC = () => {
  ...
  const selectedChannel = channelId ? channels.find((c) => c.id === channelId) : null;
  ...
  return (
    <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {selectedChannel && (
        ...
        >
          <div style={{ fontWeight: 800, fontSize: "1rem", color: "var(--wa-emerald)" }}>
        ...
        {channels.map((ch) => (
          <div
            ...
            style={{
              ...
              borderRadius: 12,
              border: ch.id === channelId ? "2px solid var(--wa-emerald)" : "1px solid var(--wa-border)"
            }}
          >
